  ...
  return (
    <div>
      {localStorage.getItem('token') && <div className="Filter" >
        ...
        <input input type='number' placeholder='Input Min Number of Beds' onChange={Beds} style={{ width: '170px' }} />
        <input input type='number' placeholder='Input Min Number of Price' onChange={Price} style={{ width: '170px' }} />
      </div>}
